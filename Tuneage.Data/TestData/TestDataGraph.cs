...
namespace Tuneage.Data.TestData
{
    public class TestDataGraph
    {
        public class Labels
        {
            ...
            public static Label LabelExisting = Label04;

            public static Label LabelNew = new Label() { Name = "Learning Curve", WebsiteUrl = "www.learningcurverecords.com" };

            public static Label LabelUpdated = new Label() { LabelId = 6, Name = "Blue Note MODIFIED", WebsiteUrl = "www.bluenoteMODIFIED.com" };
        ...
        public class Artists
        {
            ...
            public static List<Artist> ArtistsAlphabetizedByName = new List<Artist>()
            {
